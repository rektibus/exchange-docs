...
# Source: https://toobit-docs.github.io/apidocs/spot/v1/en/

[ ](#)

[v1 __](javascript:;)

  * [v1](/apidocs/spot/v1/en/)

[现货](/apidocs/spot/v1/en/) [U本位合约](/apidocs/usdt_swap/v1/en/)

[简体中文](/apidocs/spot/v1/cn/)
...
[shell](#)
  ...
  * [General Info](#general-info)
    ...
    * [SIGNED (TRADE, USER_DATA) Endpoint security](#signed-trade-user_data-endpoint-security)
    * [Public API Definitions](#public-api-definitions)
  * [Wallet Endpoints](#wallet-endpoints)
    * [Withdraw (USER_DATA)](#withdraw-user_data)
    * [Withdrawal records (USER_DATA)](#withdrawal-records-user_data)
  ...
  * [Market Data Endpoints](#market-data-endpoints)
    ...
    * [Kline/Candlestick Data](#kline-candlestick-data)
    * [24hr Ticker Price Change Statistics](#24hr-ticker-price-change-statistics)
    * [Symbol Price Ticker](#symbol-price-ticker)
    * [Symbol Order Book Ticker](#symbol-order-book-ticker)
    * [Merge Depth](#merge-depth)
  * [Websocket Market Streams](#websocket-market-streams)
    * [Live Subscribing/Unsubscribing to streams](#live-subscribing-unsubscribing-to-streams)
    * [Heartbeat](#heartbeat)
    * [Trade Streams](#trade-streams)
    * [Kline/Candlestick Streams](#kline-candlestick-streams)
  ...
  * [Spot Account/Trade](#spot-account-trade)
    ...
    * [Query Sub-account (USER_DATA)](#query-sub-account-user_data)
    * [Account Transfer](#account-transfer)
    * [Get Account Transaction History List (USER_DATA)](#get-account-transaction-history-list-user_data)
    * [Get API KEY Type (USER_DATA)](#get-api-key-type-user_data)
  * [User Data Streams](#user-data-streams)
    * [Listen Key (SPOT)](#listen-key-spot)
    * [Payload: Account Update](#payload-account-update)
    * [Payload: Order Update](#payload-order-update)
    * [Payload: Ticket push](#payload-ticket-push)
  * [Error Codes](#error-codes)
    * [10xx - General Server or Network issues](#10xx-general-server-or-network-issues)
    * [11xx - 2xxx Request issues](#11xx-2xxx-request-issues)
    * [\- Create order sell quantity too big](#create-order-sell-quantity-too-big)
    * [Filter failures](#filter-failures)
    * [Order Rejection Issues](#order-rejection-issues)
...
## API Key Setup
  ...
  * Some endpoints will require an API Key. Please refer to[ this page ](https://www.toobit.com/support/toobit-api-key-creation-guide) regarding API key creation.
...
## General API Information
  ...
  * some endpoints will require an API Key. Please refer to[this page](https://www.toobit.com/support/toobit-api-key-creation-guide)
...
success : `json { "code":0, // 0 On behalf of successful execution "result":[] // } `

Some or all of the cancellations failed: `json { "code":0, "result":[ { "orderId":"202212231234567895", "code":-2013 // }, { "orderId":"202212231234567896", "code":-2013 } ] } `
...
accountType： `MAIN`: spot account `FUTURES`: U-contract account
...
# Source: https://toobit-docs.github.io/apidocs/usd-m/v1/en/

ERROR: Failed to fetch: 404 Client Error: Not Found for url: https://toobit-docs.github.io/apidocs/usd-m/v1/en/
