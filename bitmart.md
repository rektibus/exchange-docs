...
【Important Notice】Scheduled BitMart System Upgrade Notice
In order to provide better trading services, BitMart will perform a scheduled system upgrade on August 13, 2025, from 15:00 to 18:00 (UTC+8). During this period, certain services will be temporarily suspended for approximately three hours.

Impacted Services: - Spot/Leverage Trading: Market data access, order submission and cancellations - Spot Deposits & Withdrawals: On-chain deposits and withdrawals, internal transfers, P2P trading, and fiat-to-crypto transactions - Asset Services: All asset-related functions except for asset inquiries within futures accounts - Other Features: BitMart Earn, Task Center, etc.

Unaffected Services: - User Functions: Login, registration, identity verification (KYC) - Futures Trading: Trading operations and market data access - Other Modules: Promotional activities, system notifications, etc.

We sincerely apologize for any inconvenience this may cause and appreciate your understanding and support. Please plan your trading and transfers in advance.

Change Log
2025-12-31
REST API
[Update] /spot/v1/symbols/details Get Trading Pair Details (V1)
Feat：Add new response field planned_down_time, Expected delisting time for trading pairs
2025-06-24
REST API
...
Feat：Add new response field stpMode, Identify self transaction protection type
Feat: Response field cancelSource add new value stp
[Update] /spot/v4/query/history-ordersAccount Orders(v4) (SIGNED)
Feat：Add new response field stpMode, Identify self transaction protection type
Feat: Response field cancelSource add new value stp
...
[Update] /account/v1/wallet Get Account Balance (KEYED)
Feat：Add a field for the USD valuation of available balance: available_usd_valuation.
[Update] /account/v1/currencies Get Currencies
Feat：Support querying for a single currency or multiple currencies.
Feat：Add new response field for withdrawal fee: withdraw_fee and new response field for withdrawal fee estimate: withdraw_fee_estimate. After 2015-05-18 remove the response field: withdraw_minfee.
2025-02-11
REST API
...
/spot/v2/batch_orders	New Batch Order(v1)
New Batch Order(v2)	/spot/v4/batch_orders
/spot/v1/cancel_order
/spot/v2/cancel_order	Cancel Order(v1)
Cancel Order(v2)	/spot/v3/cancel_order
/spot/v1/cancel_orders	Cancel Batch Order(v1)	/spot/v4/cancel_orders
/spot/v4/cancel_all
...
/spot/v1/ticker
/spot/v2/ticker	Get Ticker of All Pairs (V1)
Get Ticker of All Pairs (V2)	/spot/quotation/v3/tickers
...
/spot/v1/symbols/kline	Get K-Line (V1)	/spot/quotation/v3/lite-klines
...
Websocket Stream
[Update] [Private] Balance Change channel
New type value for event_type field: BMX_DEDUCTION=BMX handling fee deduction
2024-04-03
REST API
...
2022-05-24
Update endpoints for Spot
/spot/v2/ordersAdd new field clientOrderId
/spot/v1/tradesAdd new field clientOrderId
/spot/v1/order_detailAdd new field clientOrderId
2022-04-19
...
2020-06-29
New endpoints for Account
/account/v1/currenciesGet Currency
/account/v1/walletGet Account Balance
/account/v1/deposit/addressDeposit Address
/account/v1/withdraw/chargeWithdraw Quota
/account/v1/withdraw/applyWithdraw
/account/v1/recharge-withdraw/historyGet Deposit And Withdraw History
...
/spot/v1/tickerGet ticker
/spot/v1/stepsGet K-Line steps
/spot/v1/symbols/klineGet k-Line
/spot/v1/symbols/bookGet orderbook
/spot/v1/symbols/tradesGet trades
/spot/v1/walletGet user wallet
/spot/v1/submit_orderPlace order
/spot/v1/cancel_orderCancel order
/spot/v1/cancel_ordersCancel all outstanding orders in the specified direction for the specified trading pair
/spot/v1/order_detailGet order details
/spot/v1/ordersGet user recent orders
/spot/v1/tradesGet user trade history
Introduction
API Key Create
...
Copy Success  if (timestamp < (serverTime + 1000) && (serverTime - timestamp) <= recvWindow)
  {
    // process request
  } 
  else 
...
Copy Successcurl https://api-cloud.bitmart.com/system/time
None
...
Copy Successcurl https://api-cloud.bitmart.com/system/service
None
...
Copy Successcurl https://api-cloud.bitmart.com/spot/v1/currencies
None
...
Copy Successcurl https://api-cloud.bitmart.com/spot/v1/symbols
None
...
Copy Successcurl https://api-cloud.bitmart.com/spot/v1/symbols/details
None
    ...
    "symbols": [
        {
          ...
          "planned_down_time":1767148200000
        }
    ]
  }
}
...
- trading=is trading
- pre-trade=pre-open
planned_down_time	Long	Expected delisting time for trading pairs(If returned as null, there is no delisting plan,in milliseconds)
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/tickers`
None
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/ticker?symbol=BTC_USDT
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/lite-klines?symbol=BMX_ETH&step=15&limit=10
Field	Type	Required?	Description
symbol	String	Yes	Trading pair (e.g. BMX_USDT)
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/klines?symbol=BMX_ETH&step=15&limit=10
Field	Type	Required?	Description
symbol	String	Yes	Trading pair (e.g. BMX_USDT)
before	Long	No	Query timestamp (unit: second, e.g. 1525760116), query the data before this time
after	Long	No	Query timestamp (unit: second, e.g. 1525769116), query the data after this time
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/books?symbol=BTC_USDT&limit=1
Field	Type	Required?	Description
symbol	String	Yes	Trading pair (e.g. BMX_USDT)
...
Copy Successcurl https://api-cloud.bitmart.com/spot/quotation/v3/trades?symbol=BMX_ETH&limit=10
Field	Type	Required?	Description
symbol	String	Yes	Trading pair (e.g. BMX_USDT)
...
https://api-cloud.bitmart.com/account/v1/wallet?currency=USDT&needUsdValuation=true
Field	Type	Required?	Description
...
Copy Successcurl https://api-cloud.bitmart.com/account/v1/currencies?currencies=BTC,ETH,BMX
Field	Type	Required?	Description
...
This interface is not available for sub-account
1. When `withdraw_precision`=5, then the decimal point of the withdrawal amount cannot exceed 5 digits.
...
Copy Successcurl -H 'X-BM-KEY:{{AccessKey}}'
https://api-cloud.bitmart.com/account/v1/withdraw/address/list
None
...
Copy Successcurl -H 'X-BM-KEY:{{AccessKey}}'
https://api-cloud.bitmart.com/account/v2/deposit-withdraw/history?N=100&operation_type=withdraw&startTime=1739499865000
Field	Type	Required?	Description
...
Cancel Maker: Which cancels the maker order to prevent self-trading. Then, the taker order continues to match with the next order based on the order book priority.
Cancel Taker: The taker order is canceled to prevent self-trading. If the user's own maker order is lower in the order book priority, the taker order is partially filled and then canceled. FOK orders are always honored and canceled if they would result in self-trading.
Cancel Both: Both taker and maker orders are canceled to prevent self-trading. If the user's own maker order is lower in the order book priority, the taker order is partially filled. Then, the remaining quantity of the taker order and the first maker order are canceled. FOK orders are not supported in this mode.
Response Data
Response
...
-canceled=The order has been canceled.
-partially_canceled=A part of the order has been filled , and the order has been canceled.
cancelSource	String	Order cancellation reason(Return value only if the order state is canceled or partially_canceled, otherwise it will return an empty string)
-user=User manually canceled.
-system=System automatically canceled.
-stp=Stp Cancelled.
...
Copy Successcurl -H 'X-BM-KEY:{{AccessKey}}'
https://api-cloud.bitmart.com/account/sub-account/main/v1/wallet?subAccount=subAccount1@xxx.com
Field	Type	Required?	Description
subAccount	String	Yes	Sub-Account username
currency	String	No	currency
Response Data
...
Copy Success{"event":"<operation>","errorMessage":"<error_message>","errorCode":"<error_code>"}
...
Copy Successconst zlib = require('zlib');
...
Copy Success@link https://php.net/manual/en/function.gzinflate.php

gzinflate($data)
Java

Copy Successimport java.util.zip.*;
...
Copy Success{"op": "subscribe", "args": ["<topic>"]}
...
Copy Success{"op": "subscribe", "args": ["spot/ticker:BTC_USDT"]}
Subscription successful

Copy Success{"event": "subscribe","topic": "spot/ticker:BTC_USDT"}
After successful subscription, push data

Copy Success{"table":"spot/ticker:BTC_USDT","data":[]}
Unsubscribe
Cancel subscription to one or more channels

unsubscribe

Copy Success{"op": "unsubscribe", "args": ["<topic>"]}
...
Copy Success{"op": "unsubscribe", "args": ["spot/ticker:BTC_USDT", "spot/ticker:ETH_USDT"]}
Unsubscribe successful

Copy Success{"event":"unsubscribe","topic":"spot/ticker:BTC_USDT"}
...
After subscribing, the current data will be returned directly, and the latest price, bid price, ask price will be pushed only after they change.
...
First, the client send a subscription request {"op": "subscribe", "args": ["spot/depth/increase100:<symbol>"] }
After successful subscription, you will receive two types of messages, type=snapshot (full data) and type=update (update)
If a type=snapshot type message is received, update the deep snapshot content to the local cache. If there is no local cache, create one.
...
Request through request {"op": "request", "args": ["spot/depth/increase100:<symbol>"] }to obtain the latest depth snapshot (type=snapshot in the message), and add the depth The content in the snapshot is overwritten to the local cache, and then the logic continues from step 2.
Abnormal Situation:
...
Copy Success{"op":"login","args":["<YOUR_API_KEY>", "<timestamp>", "<sign>"]}
...
Copy Success{"op": "login", "args": ["80618e45710812162b04892c7ee5ead4a3cc3e56", "1589267764859", "3ceeb7e1b8cb165a975e28a2e2dfaca4d30b358873c0351c1a071d8c83314556"]}
Response

Copy Success{"event":"login"}
...
Copy Success{"event":"<operation>", "errorMessage":"", "errorCode":""}
Error Code
