...
You can register for a new HollaEx api-key and api-secret in the security section of hollaex.com.
...
HollaEx Node Library - Our official library that supports Node.js. Connects to both our API and websocket.
CCXT - An authorized library that supports Node.js, PHP, and Python. Connects to our API.
Public
Health
Request
...
Private
 You must replace API_KEY, API_SIGNATURE, and API_EXPIRES with your own values in the header of all private http requests. Refer to the authentication section above to learn more.
Get User
Request
...
curl -X GET
  ...
  -H "api-signature: $API_SIGNATURE"
  -H "api-expires: $API_EXPIRES"
  "https://api.hollaex.com/v2/subaccounts"
Response
  ...
  "data": [
    {
      ...
      "is_subaccount": true,
      "network_id": 90,
      "created_at": "2021-02-15T07:34:34.203Z"
    }
  ]
}
Get list of subaccounts for the authenticated master user. Not available for subaccounts.

HTTP Request
GET https://api.hollaex.com/v2/subaccounts
