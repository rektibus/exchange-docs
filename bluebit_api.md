...
- [Spot API Reference](#b5)
  - [open-api](#b6) ([Api Demo](https://github.com/bluebitltd/bluebitfile/blob/main/demo.txt))
...
Welcome to [BlueBit](https://www.BlueBIT.io/index) API document for developers.
...
Before signing any request, you must generate an API key via [Exchange’s official website ](https://www.bluebit.io/index)【User Center】-【API】. After generating the key, there are three things you must bear in mind:
...
Generate a string to be signed
    -   [open-api Demo](https://github.com/bluebitltd/bluebitfile/blob/main/demo.txt)
...
The root URL for REST access：``` https://openapi.bluebit.io ```
...
public class WsTest {
    ...
    public static void main(String[] args) {
        try {
//wsurl 
            String url = "wss://ws.bluebit.io/kline-api/ws";
...
//Thread does not end, waiting for new messages，www.bluebit.io Generally, a new deal will return in about a minute
            while (true) {
                Thread.sleep(1000);
            }
