...
Source: https://docs.alpaca.markets/docs/international-accounts
...
Note: The dates collected on the form are in a slightly different format than how they need to be submitted via Accounts API. It is requested by the user on the form in MM-DD-YYYY, but should be submitted as YYYY-MM-DD.Updated 5 months ago Accounts StatusesDomestic (USA) Accounts- Ask AI
