...
Source: https://docs.alpaca.markets/docs/historical-crypto-data-1
...
# Historical Crypto Data
This API provides historical market data for crypto. Check the API Reference for the detailed descriptions of all the endpoints.
...
Due to the volatility of some currencies, including lack of trade volume at any given time, we include the quote midpoint prices in the bars to offer a better data experience. If in a bar no trade happens, the volume will be 0, but the prices will be determined by the quote prices.Updated 5 months ago Historical Stock DataHistorical Option Data- Ask AI
