...
ParameterRequiredDescriptionValues
 ...
 | `max_percentage` | optional | Maximum percentage of the ticker&#x27;s period volume this

order might participate in | Decimal number, must be 0 < `max_percentage` < 1, with up to 3 decimal points precision.
...
This is not an offer, solicitation of an offer, or advice to buy or sell securities or open a brokerage account in any jurisdiction where Alpaca Securities are not registered or licensed, as applicable.Updated 5 months ago Placing OrdersUser Protection- Ask AI
