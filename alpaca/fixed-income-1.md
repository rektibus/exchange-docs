...
ParameterTypeDescription
 ...
 | bond_status | string | (Optional) Filter by status: outstanding, matured, pre_issuance.
...
ParameterTypeDescription
 | account_id | string | (Required) The account ID to place the order for.
Body Parameters:
...
ParameterTypeDescription
 ...
 | time_in_force | string | (Required) Must be day.
...
This is not an offer, solicitation of an offer, or advice to buy or sell securities or open a brokerage account in any jurisdiction where Alpaca Securities is not registered or licensed, as applicable.Updated about 1 month ago Options Trading OverviewTokenization Guide for Issuer- Ask AI
