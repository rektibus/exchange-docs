...
The existing account creation request will be used to create an IRA account but with the addition of a few new fields such as the `account_type` and `account_sub_type` fields. There will also be some additional onboarding questions that customers must answer to create their IRA account. Please reach out to your dedicated Customer Success Manager for the complete onboarding steps you&#x27;ll need to guide your customers through.
Sample Request Body
...
- IRA FAQs
- IRA Learn Article
Updated 5 months ago Data ValidationsCrypto Trading- Ask AI
