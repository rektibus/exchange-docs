...
Source: https://docs.alpaca.markets/docs/trading-api
...
Anyone globally can create an paper only account. All you need to do is sign up with your email address. Alpaca also offers live brokerage accounts (with real money) for individuals and businesses plus crypto accounts. For more click here.
...
We have enabled several types of protections to enhance your trading experience. For more click here.Updated 5 months ago Custodial accountsGetting Started with Trading API- Ask AI
